...
CUDA_VISIBLE_DEVICES=0 python3 -m torchstocks.vision.segmentation.train \
--model=torchstocks.vision.segmentation.model.deeplabv3plus.Model \
--image_size=513 \
--num_classes=21 \
--train_data_path='/mnt/cephfs/data/segmentation/voc_2012_ds' \
--train_file='train_2012.ds' \
--test_data_path='/mnt/cephfs/data/segmentation/voc_2012_ds' \
--test_file='val_2012.ds' \
--backbone='resnet18'
...
--master_port=1111 \
--nproc_per_node=2 \
-m torchstocks.vision.segmentation.train \
--model=torchstocks.vision.segmentation.model.deeplabv3plus.Model \
--image_size=513 \
--num_classes=21 \
--train_data_path='/mnt/cephfs/data/segmentation/voc_2012_ds' \
